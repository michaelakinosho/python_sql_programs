...
class MainWindow(QMainWindow):
    def __init__(self, widget):
        ...
        self.setWindowTitle("Expenses Tool Tutorial")
...
class Widget(QWidget):
    def __init__(self):
        ...
        #Example data
        self.data = {"Water": 24.5, "Electricity": 55.1, "Rent":850.0, "Supermarket": 230.4, "Internet": 29.99, "Bars": 21.85, "Public Transportation": 60.0, "Coffee": 22.45, "Restaurants": 120}
